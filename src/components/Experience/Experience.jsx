    ...
    >
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="timeline-circle absolute left-1/2 -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={experience.img}
