      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
            ...
            {/* Project Description in box model*/}
            <div className="flex flex-col">
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <a href={selectedProject.webapp || "#"} target={selectedProject.webapp ? "_blank" : undefined}
                    ...
                    className={`w-1/2 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center ${
                      selectedProject.webapp ? "bg-purple-600 hover:bg-purple-800 text-white cursor-pointer"
                        : "bg-gray-800 text-gray-600 cursor-not-allowed border border-gray-700"
                    }`}>
                    {selectedProject.webapp ? selectedProject.webapp.includes("drive.google.com") 
                    ? "View Live Video"
                    : "View Live"
                    : "Not Live Yet"}
                  </a>
